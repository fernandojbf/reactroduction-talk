...
const colors = {
  primary: brand.darkerGray,
  secondary: brand.lightblue,
  tertiary: brand.lightblue,
  quartenary: brand.lightblue
};
...
export default {
  ...
  global: {
    body: {
      background: `linear-gradient(141deg, #bff5ff 10%, #bff5ff 40%, #98efff 75%)`,
